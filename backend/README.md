...
## Project Structure
    ...
    ├── testapiautoconnect_111027  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_111027`
...
2. Clone this repo and `cd testapiautoconnect_111027`
